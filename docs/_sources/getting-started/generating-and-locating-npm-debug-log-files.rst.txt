...
npm Enterprise users: If you need to contact npm Enterprise Support at enterprise@npmjs.com, we recommend attaching the entire contents of the npm-debug.log file or copying the contents into the body of the message, so that we can more easily diagnose the problem.

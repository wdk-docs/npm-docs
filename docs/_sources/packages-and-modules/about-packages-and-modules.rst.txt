...
For more information on creating a **package.json** file, see :doc:`creating-a-package-json-file` .

Packages can be unscoped or scoped to a user or Org, and scoped packages can be private or public.
For more information, see

- :doc:`about-scopes`
- :doc:`about-private-packages`
- :doc:`package-scope-access-level-and-visibility`
